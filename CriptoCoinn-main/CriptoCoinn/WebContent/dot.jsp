...
<body class="bg">
	...
	<div class="card">
		...
		<br>
		<h3>Introdução</h3>
		<p>O Polkadot é um projeto robusto, encabeçado por uma das
			principais cabeças do Ethereum. Não apenas isso, conseguiu tração
			junto à comunidade de desenvolvedores, e é forte também no marketing,
			principalmente na Ásia. Por fim, vale considerar que o Polkadot
			atingiu uma capitalização de mercado alta, entrando no ranking das
			top 10 cryptos.</p>
		<h3>História</h3>
		<p>Polkadot foi criada e concebida pelo doutor Gavin Wood, um dos
			cofundadores da Ethereum (ETH) e inventor da linguagem de programação
			de contratos autônomos Solidity. A rede facilita a comunicação e
			interoperabilidade entre blockchains ao conectar múltiplos
			blockchains em uma rede unificada.</p>
		<h3>Diferenciais</h3>
		<p>Um dos principais diferenciais do Polkadot é a
			interoperabilidade, possibilitando uma série de blockchains que se
