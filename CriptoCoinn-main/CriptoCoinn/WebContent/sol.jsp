...
<body style="background-color: gold;">
	...
	<div class="card">
		<h3>SOLANA SOL</h3>
		<div class="foto">
		<img class="sol" src="./PaginaSol"/>
		</div>
		<br>
		<p>Solana é um projeto de código aberto altamente funcional que se baseia na natureza sem permissão da tecnologia blockchain para fornecer soluções financeiras descentralizadas.</p>
		<p>Enquanto a ideia e o trabalho inicial no projeto começaram em 2017, Solana foi lançado oficialmente em março de 2020 pela Fundação Solana com sede em Genebra, Suíça.</p>
	</div>
