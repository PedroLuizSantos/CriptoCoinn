...
<div class="card">
	<h3>CHILIZ CHZ</h3>
		<div class="foto">
			<img class="chz" src="./PaginaChz"/>
		</div>
		<br>
		<p>Chiliz é uma opção de moeda digital para produtos e serviços apoiados em blockchain.</p>
		<p>Voltados para os principais consumidores que querem elevar suas experiências cotidianas através do envolvimento dos fãs em entretenimento.</p>
		<p>É uma solução alternativa de pagamento para produtos convencionais e muito mais. </p>	
	</div>
