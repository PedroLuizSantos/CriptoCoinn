	...
	<div class="card">
		...
		<div class="row">
			...
			<div class="column">
				<div id="atributos" class="card">
					<h4>Market Cap:<h4>
					<h5 class="myDIV">${bnb_marketcap}</h5><div class="popup" onclick = "myFunction()"> <i class="fa fa-info-circle" style="font-size: 20px"></i><span class="popuptext" id="myPopup">Informações.</span>
					</div>
		...
		<br>
		<h3>O que é BNB ?</h3>
		<p>BNB é a criptomoeda criada pela Binance.</p>
		<h3>História</h3>
		<p>A BNB foi lançada em uma Oferta Inicial de Moedas (ou ICO) do
			dia 26 de junho a 3 de julho de 2017, 11 dias antes da abertura da
			Binance Exchange para negociações.</p>
		<h3>Por que usar BNB?</h3>
		<p>Você paga uma taxa para cada negociação que fizer na Binance.
			Você pode pagar essas taxas usando os ativos que está negociando, ou
			pode pagar com BNB para obter um desconto! Esse desconto será
			reduzido a cada ano até o quinto ano da Binance.</p>
	</div>
	<br>
	<script>
